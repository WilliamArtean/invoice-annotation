...
public class ProjetFactureApplication {
	...
	public CommandLineRunner demo(FactureRepository repository, AnnotationRepository arepository, PageRepository prepository) {
		return (args) -> {
			...
			arepository.save(new Annotation(10, 20, AnnotationType.POI));
			arepository.save(new Annotation(20, 30, AnnotationType.ROI));
			arepository.save(new Annotation(30, 40, AnnotationType.OOI));
